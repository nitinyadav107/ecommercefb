     ...
     <Link to='/'><img src={assets.logo} className='w-36' alt="Logo" /></Link> 
      ...
      <div className='flex item-center gap-6'>
        ...
        <div className='group relative'>
          ...
          <div className='absolute hidden group-hover:block hidden bg-white dropdown-menu right-0 pt-4'>
        ...
        <img onClick={()=>setVisible(!visible)}  src={assets.menu_icon} className='w-5 cursor-pointer sm:hidden'
        alt="" />
